...
![Windows Server Desktop](screenshots/02-windows-server-desktop.png)
...
![AD DS Roles Checked](screenshots/03-ad-ds-roles-checked.png)
![AD DS Install Complete](screenshots/04-ad-ds-install-complete.png)
...
![New Forest Setup](screenshots/05-new-forest-setup.png)
![Domain Login Screen](screenshots/06-domain-login-screen.png)
...
![OU Creation](screenshots/07-ou-creation.png)
...
![User Creation](screenshots/08-user-creation.png)
![Users in IT OU](screenshots/09-users-in-ous.png)
![Users in HR OU](screenshots/09.1-users-in-ous.png)
![Users in Finance OU](screenshots/09.2-users-in-ous.png)
...
![GPO Password Policy](screenshots/10-gpo-password-policy.png)
![GPO Account Lockout](screenshots/10.1-gpo-password-policy.png)
![GPO Linked to Domain](screenshots/11-gpo-linked.png)
...
![DC01 IP Config](screenshots/14-dc01-ipconfig.png)
![Ping DC01 Success](screenshots/15-ping-dc01.png)
![DNS Settings](screenshots/16-dns-settings.png)
...
![Join Domain Credentials](screenshots/16b-join-domain-credentials.png)
![Welcome to Domain](screenshots/17-welcome-to-domain.png)
...
![Domain User Login](screenshots/18-domain-user-login.png)
![Domain User Desktop](screenshots/19-domain-user-desktop.png)
